...
import logo from "../../assets/images/Mein_Logo.png";
...
const Portfolio = () => {
  ...
  const skills = useMemo(() => [
    { icon: <FaCode />, title: t("skill_webdev_title"), desc: t("skill_webdev_desc") },
    { icon: <FaRocket />, title: t("skill_perf_title"), desc: t("skill_perf_desc") },
    { icon: <FaPalette />, title: t("skill_design_title"), desc: t("skill_design_desc") },
  ], [t]);
  ...
  return (
    <div className="Portfolio">
      ...
      >
        ...
        >
          <Button className="BubbleButton btn-primary" onClick={handleViewWork}>{t("portfolio_cta_work")}</Button>
          <Button className="BubbleButton btn-secondary" onClick={handleContact}>{t("portfolio_cta_contact")}</Button>
        </motion.div>
